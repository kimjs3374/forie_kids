...
class Config:
    ...
    ADSENSE_VERIFICATION_META = os.getenv("ADSENSE_VERIFICATION_META", "")
    ADSENSE_HEAD_HTML = os.getenv("ADSENSE_HEAD_HTML", "")
    ...
    ADMIN_TELEGRAM_URL = os.getenv("ADMIN_TELEGRAM_URL", "")